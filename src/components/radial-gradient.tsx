...
import { setGradnentColor, setFirstColorPosition, setSecondColorPosition } from '../store/slices/preview-slice';
...
const RadialGradientGenerator = () => {
  ...
  const updatePosition = (e: React.MouseEvent<HTMLDivElement> | MouseEvent) => {
    ...
    dispatch(setFirstColorPosition(Math.round(newPosX)));
    dispatch(setSecondColorPosition(Math.round(newPosY)));
  ...
  const addColorStop = () => {
    ...
    dispatch(setGradnentColor(generateGradientString()))
